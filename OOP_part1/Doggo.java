...
class AppStartClass {
    public static void main(String[] args) {
        ...
        System.out.println("OOP_part1.Doggo " + doggoMax.getName() + " is a " + doggoMax.getSubClassOfAnimals());
        System.out.println("OOP_part1.Doggo " + doggoJeff.getName() + " is a " + doggoJeff.getSubClassOfAnimals());

        if (doggoJeff.getAge() >= 0)
            System.out.println(
                "OOP_part1.Doggo " + doggoJeff.getName() + " is a " + doggoJeff.getSubClassOfAnimals() + " and he is " + doggoJeff.getAge() + " yo."
        );
        else System.out.println(doggoJeff.getName() + "'s age is not set!");

        if (doggoMax.getAge() >= 0)
            System.out.println(
                "OOP_part1.Doggo " + doggoMax.getName() + " is a " + doggoMax.getSubClassOfAnimals() + " and he is " + doggoMax.getAge() + " yo."
        );
        else System.out.println(doggoMax.getName() + "'s age is not set!");

        // Change the age of Max here, can be used for other OOP_part1.Doggo objects too.
        doggoMax.setAge(2);
        if (doggoMax.getAge() >= 0)
            System.out.println(
                "OOP_part1.Doggo " + doggoMax.getName() + " is a " + doggoMax.getSubClassOfAnimals() + " and he is " + doggoMax.getAge() + " yo."
